...
-I $realign_bamfile -o sorted.realn.bam.recalibration_report.grp -L $chr --disable_indel_quals

java -Xmx14g -jar GenomeAnalysisTKLite.jar -nct 8 -T PrintReads \\
-R $reference \\
-I $realign_bamfile -BQSR sorted.realn.bam.recalibration_report.grp -o $realign_bqsr_bamfile
" >> gatk_$chr.sh
...
echo "java -Xmx14g -jar GenomeAnalysisTKLite.jar -nct 8 -T UnifiedGenotyper \\
-R $reference -D $dbsnp \\
